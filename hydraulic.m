...
hold on
title('DNB')
plot(z,(DNBu),'.',z,(DNBnu),'x',z,(DNBbw),'>')
legend('W3-uniform','W3-nonuniform','bowring')
xlabel('Z[cm]') % left y-axis 
...
plot(z,Q2A*10^-6,'.')
xlabel('Z[cm]') % left y-axis 
ylabel('Densidade de potência superficial[MW/m²]') % right y-axis
